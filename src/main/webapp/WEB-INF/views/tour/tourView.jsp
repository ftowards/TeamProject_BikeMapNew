...
<div id="mainDiv">
	...
	<div id="conditionDiv">
			...
			<div id="tourReplyDivMain">
				...
				<div id="tourCommentWriteDiv">
					<textarea name="comment" id="tourCommentWrite" maxlength="100" placeholder="주제와 무관한 댓글, 악플은 삭제될 수 있습니다."></textarea>
					<div id="tourTextCntDiv"><span style="padding-right:10px;">0&nbsp;/200</span></div>
					<form>	
						<div><input type="submit" value="등 록" id="tourCommentSubmit"></div>
					</form>	
				</div>
				<hr/>
				<div id="tourCommentViewDiv">
				<ul>
