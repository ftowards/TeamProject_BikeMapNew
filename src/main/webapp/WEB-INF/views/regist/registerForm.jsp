...
<div class="registerMainDiv" style='margin-bottom:150px'>
	<form id="registerForm" method="post" action="<%=request.getContextPath()%>/registerFormOk">
		<ul>
			...
			<li id="input">
				<ul class='input_ul'>
					<li><input type="text" name="userid" id="userid" class="i1" maxlength="12" size="12" autocomplete="off"/> <input type="button" class="gray_Btn" id="idChk" style='font-size:15px' value="중복검사"/></li>
						<li><span class="reg">&ensp;※ 8~12자 영문(시작)/숫자/_ 사용</span></li>
					<li><input type="password" name="userpwd" id="userpwd" class="i2" maxlength="12" size="20" style='font-size:40px; padding-bottom:10px'/></li>
						<li><span class="reg">&ensp;※ 8~12자리 영문/숫자/특수문자 사용</span></li>
					<li><input type="password" name="userpwdChk" id="userpwdChk" class="i2" maxlength="12" size="20" style='font-size:40px; padding-bottom:10px'/></li>
					...
					<li style='margin-top:52px'><input type="radio"name="gender" id="male" value="1"/><label for="male" class="tlbl2" style='margin-right:80px'>남 자</label>
						...
						<li><span class="reg">&ensp;</span></li>
					<li style='margin-top:-9px; position:relative; bottom:4px;'><input type="text" name="birth" id="datepicker" class="i2" maxlength="10" autocomplete="off" style='position:relative; bottom:16px;'></li>	
						<li><span class="reg" style='position:relative; bottom:17px;'>&ensp;※ ex)1980-12-03</span></li>	
				</ul>
			</li>
			<li id="buttons2">
				<input type="submit" class="mint_Btn" value="회원가입" style='margin:10px 15px 10px 73px'/>
